...
\begin{table}[H]
    ...
    \begin{ctucolortab}
        \begin{tabular}{cccccccc}
            \toprule
            Charakteristika                           & Symbol           & Min                 & Typ               & $\textnormal{Max}$ & Jednotka                                          & Testovací podmínky & \\ \midrule
            Impedance analogového vstupu              & $Z_{in}$         & -                   & 260               & -                  & $k \Omega$                                        & Gain = 1           & \\
            Rozlišení zavislé na OSR                  & Rozlišení        & 24                  & -                 & -                  & bit                                               & OSR $\geq$ 256     & \\
            ...
            Chyba zesílení závislé na teplotě         & $G_{E \ DRIFT}$  & -                   & 0.5               & 2                  & $\frac{ppm}{^\circ C}$                            & Gain = 1,2,4       & \\
            Integrální nelinearita                    & $INL$            & -7                  & -                 & +7                 & ppm $\textnormal{FSR}^{(\ref{enum:mcp_adc_fsr})}$ & Gain = 1           & \\
