...
Tato sekce se zaměří o popsání charakteristiky 12 bit AD převodníku a 24 bit AD převodníku MCP3561. Měření probíhalo na třech veličinách, vstupní piny byly zkratovány s referenční zemí, na napětí z DPS $U_{ref} = 3.3 \ V$ a poté pomocí napěťového děliče ze $U_{ref}$ na $U_{h} = 1.63 \ V$.
...
12 bit AD převodník je součástí MCU STM32F407ZGT6. AD převodník slouží k měření absolutní hodnoty tlaku z tlakových sensorů na obou větví pneumatického systému.
