...
\begin{thanks}
	Tímto chci poděkovat svému vedoucímu práce doc. Ing. Vratislavu Fabiánovi, Ph.D. za odborné vedení a poskytnutí prostředků pro realizaci systému. Firmě BTL Medical Technologies s.r.o za odborný náhled a poskytnutí strojů pro sestavení tvořeného systému. 
\end{thanks}
...
\begin{abstract-english}
	...
	measurement and evaluation of its parameters. Finally, the measured pulse wave pressure at a cuff pressure of $200 \ mmHg$ and $275 \ mmHg$ are shown.
...
měření a vyhodnocení jeho parametrů. Na zavěr je ukázána naměřené pulzní tlakové vlny při manžetovém tlaku $200 \ mmHg$ a $275 \ mmHg$.
\end{abstract-czech}
