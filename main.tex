...
mikroprocesor STM32, dálkový upgrade firmware z uživatelského prostředí a vytvoření softwarového systému tzv. Board Support Package pro podporu více verzí desky plošného spoje.
\par
