...
Bakalářská práce se zabývá návrhu a realizace systému pro neinvazivní měření hemodynamických parametrů krevního řečiště člověka oscilometrickou metodou. Mezi měřené parametry patří rychlost pulzní vlny a centrální aortální tlak. 
První část je zaměřena na teoretickému popisu hemodynamických parametrů a rešerši komerčně dostupných přístrojů pro neinvazivní měření hemodynamických parametrů. V další části je hardwarový návrh a dokumentace systému. Na to navazuje charakterizace celého přístroje, 
