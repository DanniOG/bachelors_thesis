...
Resistor na gate tranzistoru zajisti známé napětí, pokud bude vstup na gate plovoucí, tím se zamezí neznámé chovaní tranzistoru.
...
Napájecí napětí o hodnotě $5 \ V$ bylo zvoleno, po provedení testů, které ukázaly, že zvolené napájecí napětí vyhovuje požadavkům a únik tlaku při plném sevření nijak neovlivňuje terapii a přidáním $6 \ V$ napájení by se zvýšila komplexita návrhu systému.
...
\begin{equation}
    ...
    I = \frac{U_i}{R_{||}}
\end{equation}
Paralelní resistory $R_1 = R_2 = 51 \ \Omega$ mají výslednou hodnotu:
\begin{align*}
...
Zapojení obsahuje oddělené filtrování analogové a digitální napajecí reference, pro který je použit RC článek typu dolní propusti s parametry resistoru $R = 10 \ \Omega$ a kondenzátoru $C = 1100 \ nF$, kde zlomová frekvence RC článku je $f_c \doteq 14.5 \ kHz$.
\par
